...
use Nicy\Framework\Bindings\JWT\Contracts\Claim as ClaimContract;
...
abstract class Claim implements Arrayable, ClaimContract, Jsonable, JsonSerializable
{
    ...
    /**
     * Validation the claim in a standalone Claim context.
     *
     * @param mixed $value
     * @return bool
     */
    ...
    /**
     * Validation the Claim within a Payload context.
     *
     * @return bool
     */
    ...
    /**
     * Validation the Claim within a refresh context.
     *
